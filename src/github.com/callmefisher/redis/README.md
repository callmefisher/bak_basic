...
- [Pub/Sub](https://godoc.org/github.com/callmefisher/redis#PubSub).
- [Transactions](https://godoc.org/github.com/callmefisher/redis#Multi).
- [Pipeline](https://godoc.org/github.com/callmefisher/redis#example-Client-Pipeline) and [TxPipeline](https://godoc.org/github.com/callmefisher/redis#example-Client-TxPipeline).
- [Scripting](https://godoc.org/github.com/callmefisher/redis#Script).
- [Timeouts](https://godoc.org/github.com/callmefisher/redis#Options).
- [Redis Sentinel](https://godoc.org/github.com/callmefisher/redis#NewFailoverClient).
- [Redis Cluster](https://godoc.org/github.com/callmefisher/redis#NewClusterClient).
- [Cluster of Redis Servers](https://godoc.org/github.com/callmefisher/redis#example-NewClusterClient--ManualSetup) without using cluster mode and Redis Sentinel.
- [Ring](https://godoc.org/github.com/callmefisher/redis#NewRing).
- [Instrumentation](https://godoc.org/github.com/callmefisher/redis#ex-package--Instrumentation).
- [Cache friendly](https://github.com/callmefisher/cache).
- [Rate limiting](https://github.com/callmefisher/redis_rate).
- [Distributed Locks](https://github.com/bsm/redis-lock).

API docs: https://godoc.org/github.com/callmefisher/redis.
Examples: https://godoc.org/github.com/callmefisher/redis#pkg-examples.
...
```shell
go get -u github.com/callmefisher/redis
```

Import:

```go
import "github.com/callmefisher/redis"
```
...
Please go through [examples](https://godoc.org/github.com/callmefisher/redis#pkg-examples) to get an idea how to use this package.
